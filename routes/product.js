...
const { allProducts, detailProducts, createProducts, deleteProducts, updateProducts,createReviews,adminProduct,aggregateCategories } = require('../controllers/product.js')
const { authorizationMid, roleChecked } = require('../middleware/auth.js')

const router = express.Router()

router.get('/products', allProducts)
router.get('/categories', aggregateCategories);
